...
public class NewClasses extends AppCompatActivity {
    ...
    EditText etSname, etSroom, etStart, etEnd, etTLessons;
    ...
    String ID;
    String combinedtime;
    String strId,strName,type, strLessons;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            etTLessons = (EditText) findViewById(R.id.etTLessons);
...
//            db.execSQL("create table if not exists student(t_id INTEGER PRIMARY KEY AUTOINCREMENT, a_id VARCHAR)");
            ...
            if (student.isEmpty()) {
                ...
                if (c.getCount() > 0) {
                    ...
                    adapter1 = new ArrayAdapter<String>(NewClasses.this, android.R.layout.simple_list_item_multiple_choice, student);
//                            adapter1.notifyDataSetChanged();
                    lvStudent.setAdapter(adapter1);
                    adapter1.notifyDataSetChanged();
                    lvStudent.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE);
                } else {
                    Toast.makeText(getApplicationContext(), "No student yet!", Toast.LENGTH_SHORT).show();
                }
            } else {
        ...
        switch (v.getId()){
            ...
            case R.id.btnCreate:
                ...
                try{
                    ...
                    strLessons = etTLessons.getText().toString();
                    ...
                    if(sname.isEmpty()){
                    ...
                    }else if(strLessons.isEmpty()){
                        etTLessons.setError(null);
                        etTLessons.setError("Fill in the Blanks!");
                        ...
                        if (f.getCount() > 0){
                            ...
                            db.execSQL("insert into subject (s_name, room, days,time,a_id, lessons)values('"+sname+"', '"+sroom+"','"+days+"','"+combinedtime+"', '"+strId+"', '"+strLessons+"')");//subject
