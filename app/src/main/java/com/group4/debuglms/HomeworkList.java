...
public class HomeworkList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            if(strStatus.equalsIgnoreCase("submitted") || strStatus.equalsIgnoreCase("late_submitted")){
            }else{
...
//                        Toast.makeText(getApplicationContext(), ID+"", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(getApplicationContext(), "try dito"+e.toString(), Toast.LENGTH_SHORT).show();
        }
    }
    @Override
